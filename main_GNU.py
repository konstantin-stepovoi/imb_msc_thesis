...
def print_help():
    ...
    print("       mapper_method [middle|proportional|start|stop]")
...
def run_analysis(settings):
    ...
    with open("cur_metadata.txt", "w") as meta:
        ...
        meta.write(f"Type: {settings['analysis_type']}\n")
    ...
    while True:
        ...
        if cmd == "--help":
            ...
            try:
                ...
                elif param == 'mapper_method' and value in ['middle', 'proportional', 'start', 'stop']:
